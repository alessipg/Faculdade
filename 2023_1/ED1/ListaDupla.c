#include <stdio.h>
#include <stdlib.h>
//N�s agora ter�o campo prox e campo anterior (preview)
//preview do primeiro n� sempre aponta para null, assim como o prox do ultimo aponta para Null;
...
void insereInicio(Lista *lista, int k){
    ...
    if(!novo) return;
    novo->chave = k;
    if(!lista->inicio){//verifica se a lista � unit�ria
    novo->ant = NULL;
    novo->prox = NULL;
    lista->inicio = novo;
    }
